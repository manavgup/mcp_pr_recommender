...
def pr_recommender_config(sample_config):
    ...
    config.update({
        ...
        "grouping": {
            ...
            "file_path_similarity": {
                "enabled": True,
                "weight": 0.3
            },
            "change_type_grouping": {
                "enabled": True,
...
def mock_pr_grouper():
    ...
    grouper.optimize_groups.return_value = {
        ...
        "final_score": 0.87,
        "improvements": [
            "Moved test files to feature groups",
        ...
        "by_feature": {
            ...
            "expected_groups": [
                ...
                },
                {
                    ...
                    "files": ["src/user/profile.py", "src/user/settings.py", "tests/test_user.py"]
                }
            ]
        },
        "by_risk": {
            ...
            "expected_groups": [
                ...
                },
                {
                    ...
                    "files": ["src/utils/helper.py", "tests/test_helper.py", "docs/readme.md"]
                }
            ]
        },
        "by_size": {
...
def assert_recommendation_valid(recommendation: Dict[str, Any], rules: Dict[str, Any]):
    ...
    if "estimated_size" in recommendation:
        ...
        if valid_sizes:
            assert recommendation["estimated_size"] in valid_sizes, \
...
def edge_case_scenarios():
    ...
    return {
        ...
        "single_file": {
            ...
            "input": {
                "changes": [FileChangeFactory.create()]
            },
        ...
        "too_many_files": {
            ...
            "input": {
                "changes": [FileChangeFactory.create() for _ in range(50)]
            },
        ...
        "all_high_risk": {
            ...
            "input": {
                "changes": [
                    FileChangeFactory.create(risk_score=0.9) 
                    for _ in range(5)
                ]
            },
...
def performance_test_data():
    ...
    return {
        ...
        "complex_dependencies": {
            ...
            "changes": [
                FileChangeFactory.create(
                    file_path=f"src/interconnected_{i}.py"
                ) for i in range(20)
            ],
            "dependency_matrix": {
